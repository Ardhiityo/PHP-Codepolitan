    ...
    <div class="container d-flex flex-column mt-5 w-50 justify-content-center">
        <form action="{{ url("/tasks/$task->id") }}" method="post">
            ...
            <div class="mb-5">
                ...
                @enderror
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="task">{{ old('task', $task->task) }}</textarea>
            </div>
            <div class="d-flex">
                <button type="submit" class="mx-auto btn btn-primary btn-lg">Update task</button>
            </div>
        </form>
    </div>
@endsection
